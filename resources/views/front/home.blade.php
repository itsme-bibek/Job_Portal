                    ...
                    @foreach ($category as $categories)
                        <div class="col-lg-4 col-xl-3 col-md-6">
                            <div class="single_catagory">
                                <a href="jobs.html">
                                    <h4 class="pb-2">{{ $categories->name }}</h4>
                                </a>
                    ...
                    <div class="job_lists">
                        <div class="row">
                            ...
                            @if ($featured->isNotEmpty())
                                @foreach ($featured as $featuredJob)
                                    <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <div class="card border-0 p-3 shadow mb-4">
                                    <div class="card-body">
                                        ...
                                        <div class="d-grid mt-3">
                                            <a href="{{ route('details',$latest->id) }}" class="btn btn-primary btn-lg">Details</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
