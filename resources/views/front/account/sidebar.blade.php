<div class="card border-0 shadow mb-4 p-3">
    <div class="s-body text-center mt-3">
        ...
        @else
            <img src=" {{ asset('icon.png') }}" alt="avatar" class="rounded-circle img-fluid" style="width: 150px;">
        @endif



        <h5 class="mt-3 pb-0"><span style="text-transform: uppercase; color:#000">{{ Auth::user()->name }}</span></h5>
